        ...
        <form className="space-y-6">
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input type="email" placeholder="name@company.com" className="w-full pl-12 py-3 bg-gray-50 border-gray-100" />
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input type="password" placeholder="••••••••" className="w-full pl-12 py-3 bg-gray-50 border-gray-100" />
            </div>
          </div>
          
          <button type="button" className="btn btn-primary w-full py-4 !rounded-xl text-lg mt-2">
            Login
          </button>
        </form>
