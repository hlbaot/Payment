      ...
      <div className="container max-w-[1140px] mx-auto px-6 pt-12">
        ...
        <div className="mb-10">
          ...
          <p className="text-gray-500 text-[15px] font-medium leading-relaxed">
            Verify the details before finalizing your secure settlement.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-7 flex flex-col gap-6">
            <div className="bg-white rounded-[32px] p-8 md:p-10 shadow-sm border border-gray-100/80">
              <h2 className="text-[18px] font-bold text-gray-900 mb-6">Payment Information</h2>
              ...
              <div className="flex items-start gap-5 mb-8">
               ...
               <div className="flex flex-col pt-1">
                 <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1.5">Recipient/Biller</span>
                 <span className="text-[17px] font-bold text-gray-900">Global Utility Bill</span>
               </div>
              </div>
              ...
              <div className="flex items-start gap-5 mb-8">
               ...
               <div className="flex flex-col pt-1">
                 <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1.5">Service Type</span>
                 <span className="text-[17px] font-bold text-gray-900 tracking-tight">High-velocity liquid settlement</span>
               </div>
              </div>
              ...
              <div className="flex items-start gap-5 mb-8">
               ...
               <div className="flex flex-col pt-1">
                 <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1.5">Payment Method</span>
                 <div className="flex items-center gap-3">
                   <span className="text-[17px] font-bold text-gray-900">USD Wallet Balance</span>
                   <span className="bg-[#EFF6FF] text-[#2563EB] text-[9.5px] font-bold uppercase tracking-widest px-2 py-1 rounded-md mb-0.5">Default</span>
                 </div>
               </div>
              </div>
              ...
              <div className="flex items-start gap-5">
               ...
               <div className="flex flex-col pt-1">
                 <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1.5">Reference Number</span>
                 <span className="text-[17px] font-bold text-gray-600 tracking-wide">KINETIC-PAY-98723</span>
               </div>
              </div>
            </div>
            ...
            <div className="bg-[#F8F9FA] border border-gray-200/60 rounded-[16px] p-5 flex items-start gap-4">
               ...
               <p className="text-[13.5px] font-medium text-gray-500 leading-snug pt-0.5">
                  Your transaction is protected by Kinetic 256-bit encryption and multi-sig verification.
               </p>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 flex flex-col">
            <div className="bg-white rounded-[32px] overflow-hidden shadow-[0_12px_40px_rgba(0,0,0,0.06)] border border-gray-100 flex flex-col">
               ...
               <div className="bg-[#FFF6F0] p-8 md:px-10 md:py-9 relative border-b border-[#FFE8D6]">
                 ...
                 <span className="block text-[#E65C00] font-bold text-[12px] tracking-widest uppercase mb-1">Payment Summary</span>
                 <span className="block text-[12px] font-medium text-gray-500 mb-2">Current Balance</span>
               ...
               <div className="p-8 md:px-10 md:py-8 flex-1">
                  <div className="flex justify-between items-center mb-6">
                     <span className="text-[14.5px] font-medium text-gray-500">Payment Amount</span>
                     <span className="text-[16px] font-bold text-gray-900">$50.00</span>
                  </div>
                  <div className="flex justify-between items-center mb-8">
                     <span className="text-[14.5px] font-medium text-gray-500">Processing Fee</span>
                  ...
                  <div className="flex justify-between items-end mb-8">
                     <span className="text-[16px] font-bold text-gray-900 pb-0.5">Total to Deduct</span>
                  ...
                  <div className="bg-[#F8F9FA] border-l-[4px] border-[#0ea5e9] py-4 px-5 rounded-r-[12px] flex justify-between items-center mb-10 shadow-sm shadow-[#0ea5e9]/5">
                     <span className="text-[12px] font-bold text-gray-600">Balance After Payment</span>
