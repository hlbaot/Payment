      ...
      <div className="container max-w-[1140px] mx-auto px-6 pt-10">
        ...
        <div className="mb-12">
          ...
          <p className="text-gray-500 text-[15px] max-w-2xl leading-relaxed">
            Initiate a new transaction request through SwiftGuard Kinetic's global escrow system. Ensure all information is accurate before confirming.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-7 bg-[#FFF6F0] rounded-[32px] p-8 md:p-10 border border-[#FFE8D6]">
            ...
            <div className="flex items-start gap-4 mb-10">
              ...
              <div className="pt-0.5">
                <h2 className="text-[20px] font-bold text-gray-900 mb-1 tracking-tight">Transaction Information</h2>
                <p className="text-gray-500 text-[13px] font-medium">Please fill in all the required information below.</p>
              </div>
            </div>
            ...
            {/* Amount Field */}
            <div className="mb-8">
              <label className="block text-[13px] font-bold text-gray-900 mb-2">Amount (USD) *</label>
            ...
            <div className="bg-[#FFF0E6] border border-[#FFE0CC] rounded-xl p-5 flex items-start gap-4 shadow-sm">
              ...
              <p className="text-gray-800 text-[14px] font-medium leading-relaxed pt-0.5">
                Live exchange rates updated every 30 seconds for transparency.
              </p>
            </div>
          ...
          <div className="lg:col-span-5 bg-white border border-gray-200 rounded-[32px] p-8 md:p-10 shadow-[0_8px_30px_rgb(0,0,0,0.04)] sticky top-28">
            <h2 className="text-[22px] font-bold text-gray-900 mb-2 tracking-tight">Order Summary</h2>
            <p className="text-gray-500 text-[13px] font-medium mb-8">Review financial details before proceeding.</p>
            ...
            <div className="bg-[#FFF6F0] rounded-2xl p-5 flex items-center justify-between mb-8 border border-[#FFE8D6]">
              <div className="flex items-center gap-3">
                ...
                <span className="text-[14px] font-bold text-gray-700">Current Balance</span>
              </div>
            ...
            <div className="flex justify-between items-center py-4">
              <span className="text-[14px] font-bold text-gray-500">Required Amount</span>
              <span className="text-[16px] font-bold text-gray-900">{amount ? `$${amount}` : '$0.00'}</span>
            </div>
            
            <div className="flex justify-between items-center py-4">
              <div className="flex items-center gap-1.5 opacity-90">
                <span className="text-[14px] font-bold text-gray-500">Expected Commission</span>
            ...
            <div className="flex justify-between items-center py-2 mb-8 bg-[#FFFDFB] rounded-lg">
              <span className="text-[14px] font-bold text-primary">Remaining Balance</span>
            ...
            <div className="flex items-start gap-3 mb-10 text-gray-500">
              ...
              <p className="text-[11.5px] font-medium leading-[1.6]">
                This transaction is protected by AES-256 Bit Encryption and Kinetic anti-fraud systems.
              </p>
            </div>
