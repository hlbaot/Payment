...
export default function FindALocationPage() {
  ...
  const locationsCountLabel = '71 locations';
  ...
  return (
    <div className="location-page">
      {!showFilters ? (
        <div className="location-page__topbar">
      ...
      <aside className="location-page__sidebar" aria-label="Location search panel">
        {showFilters ? (
          ...
          <div className={`location-results-sheet${showResultsPanel ? ' is-open' : ''}`}>
            <button
              type="button"
              className="location-results-sheet__toggle"
              onClick={() => setShowResultsPanel((current) => !current)}
              aria-expanded={showResultsPanel}
            >
              <span className="location-results-sheet__grab" aria-hidden="true" />
              <span className="location-results-sheet__count">{locationsCountLabel}</span>
            </button>

            <div className="location-results-sheet__body">
      ...
      {showResultsPanel ? (
        <button
          type="button"
          className="location-mobile-switch"
...
function MapIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true">
      <path
        d="M9 5 3 7.5v11L9 16m0-11 6 2.5m-6-2.5v11m6-8.5 6-2.5v11L15 19m0-11v11"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
